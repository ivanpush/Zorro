# ZORRO Backend - Composer & Prompts

All prompt templates and the builder class.

---

## app/composer/library.py
...
## app/composer/__init__.py

```python
from .library import PromptLibrary
from .builder import Composer

__all__ = ["PromptLibrary", "Composer"]
```
