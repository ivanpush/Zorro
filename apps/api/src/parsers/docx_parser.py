...
class DocxParser(BaseParser):
        ...
        for docx_para in doc.paragraphs:
            ...
            if self.figure_pattern.match(para_text):
                figure = Figure(
                    ...
                    after_paragraph_id=paragraphs[-1].id if paragraphs else None,
            ...
            section_id = None
            if current_section_idx < len(sections):
                section_id = sections[current_section_idx].id
    ...
    def _extract_floating_figures(
        ...
        for rel in doc.part.rels.values():
            if "image" in rel.reltype:
                ...
                # Try to find associated captions
                figure = Figure(
                    id=f"fig_{fig_index:03d}",
                    index=fig_index,
                    caption=None,  # Will need more complex logic to associate
    ...
    def _split_into_sentences(self, text: str, para_id: str) -> list[Sentence]:
        ...
        # This is a simplified approach - could use NLTK or spaCy for better accuracy
    ...
    def _get_xml_path(self, para: DocxParagraph) -> str | None:
        ...
        try:
            ...
            if hasattr(para, '_element'):
                ...
                # Build a simple XPath-like identifier
                # In practice, we might need the actual position in the document
